            ...
            >
              ...
              <AccordionContent className="bg-gray-200 rounded-xl p-3">
                ...
                <ol className="flex flex-col gap-3 list-decimal pl-5 pt-2">
                  ...
                  <li>
                    Please select Compiler Type: <b> Solidity (Single-file).</b>
                  </li>
                  <li>
                    Please select Compiler Version:{' '}
                    <b> v0.8.24+commit.e11b9ed9</b>{' '}
                    <i className="pl-5">
                      Make sure <b>Un-Check to show all nightly Commits also</b>{' '}
                      is checked.
                    </i>
                  </li>
                  <li>
                  ...
                  <li>
                    Copy the Contract code form below and Paste the code in the
                    text are in the new page.
                  </li>
                  <li>
