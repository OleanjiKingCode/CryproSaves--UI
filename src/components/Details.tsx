      ...
      <DialogContent className="text-black bg-white outline-none">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="py-1 px-2 bg-gray-400 flex items-center rounded-md w-[60%] col-span-3">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="py-1 px-2 bg-green-200 flex items-center rounded-md  w-[60%] col-span-3">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="py-1 px-2 bg-blue-200 flex items-center rounded-md w-[60%] col-span-3">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="py-1 px-2 bg-red-100 flex items-center rounded-md w-[60%] col-span-3">
