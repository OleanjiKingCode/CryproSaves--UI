...
export const Stats = () => {
  return (
    <div className="w-full flex flex-row gap-5 items-center justify-center pt-4 px-16 flex-wrap md:flex-nowrap">
      <div className="rounded-2xl py-7 px-5 w-[200px] h-[150px] flex flex-col items-center justify-center text-center gap-4 bg-white">
